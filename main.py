...
def main():
	...
	parser.add_argument("--input", help="Ontology to query for its similar entities with a number of predefined topics")
	parser.add_argument("--output", help="Output file, containing all similar entities to predefined topics")

	args = parser.parse_args()
	inputOntology = args.input
